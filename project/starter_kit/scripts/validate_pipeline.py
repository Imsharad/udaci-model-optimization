...
from src.compression.multi_stage_pipeline import MultiStageCompressionPipeline
from src.utils.model import MobileNetV3_Household
...
def validate_individual_techniques():
    ...
    from src.utils.compression import calculate_sparsity
    from src.utils.model import get_model_size
